import React,{Component} from 'react';
 ...
 class Item_Notification extends Component {
    ...
    render() {
        return (
          <div className="item border-danger">
            <div className="right Content">
              <svg version="1.1" className="notification-icon danger right" x="0px" y="0px" width="510px" height="510px" viewBox="0 0 510 510" style={{enableBackground: 'new 0 0 510 510'}} xmlSpace="preserve">
              ...
              <h3 className="title right">متن پیام ها در این قسمت دیده میشود </h3>
              <div className="clear-fix" />
            </div>
            <div className="left icno-close">
